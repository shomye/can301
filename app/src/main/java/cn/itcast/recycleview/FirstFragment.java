...
public class FirstFragment extends Fragment {
    ...
    private String[] name = {"蕉城","古田","屏南","周宁","Wuxi","福安","柘荣","福鼎","霞浦","其他"};
    private String[] name1 = {"蕉城区","古田县","屏南县","周宁县","Wuxi City","福安市","柘荣县","福鼎市","霞浦县"};
    ...
    private String[] fudingoicons = {"https://recycleimage.oss-cn-hangzhou.aliyuncs.com/%E7%A6%8F%E9%BC%8E%E5%B8%82/%E5%A4%AA%E5%A7%A5%E5%B1%B1/tailaoshan.png",
            ...
            "https://recycleimage.oss-cn-hangzhou.aliyuncs.com/%E6%8E%A8%E8%8D%90/jiul.png",
    ...
    private String[] fudingbuy = {"¥90","¥35","¥25","¥325","¥37","¥44","¥80","¥68","¥60","free","free","free"};
    private String[] fudingpingfen = {"4.7points","4.4points","4.2points","4.4points","4.3points","4.3points","4.8points","4.5points","4.3points","4.4points","4.6points","4.7points"};
    ...
    private String[] fudingintroduce1 ={"    太姥山以花岗岩峰林岩洞为特色，融山、海、川和person文景观于一体，拥有山峻、石奇、洞...",
            "    牛郎岗海滨这里气候冬暖夏凉，素以“碧海金沙好消夏”而吸引各地游客慕名而至...",
            "    翠郊古民居是迄今为止在江南地区所发现的单体建筑面积大、保存完好的古民居，堪称江南古民居之杰作...",
            "    九鲤溪瀑景区是太姥山“山、海、川、岛”四大风景名胜区的重要组成部points，主溪流长25公里，汇集13条支流...",
...
private String[] nametwo = {"三都澳","霍童古镇","宁德东湖水利风景区","福建支提山国家森林公园","宁德洋中水利风景区","宁德蕉城区上金贝中华畲家寨","洪口水库","宁德鹤林宫","宁德市博物馆",
    ...
    private int[] icons = {R.drawable.sanduao,R.drawable.huotongguzheng,R.drawable.shuili,R.drawable.senglin,R.drawable.yangzhong,R.drawable.shangjinbei,R.drawable.hongshui,R.drawable.helin,R.drawable.bowuguan,
            R.drawable.gutianxian,R.drawable.cuipinghu,R.drawable.qiyunshi, R.drawable.achuncanguang,R.drawable.changyangxunshi,R.drawable.jinzhonghushanzhuan,R.drawable.fenglinshi,R.drawable.fenglinshizuo,R.drawable.changlinshi,R.drawable.yuanyinguju,R.drawable.gutianlinshuigong,
