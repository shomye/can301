...
public class ZhujiemianActivity extends AppCompatActivity {
    ...
    private String[] jiaobuy = {"¥32","free","free","free","free","¥35","free","free","free"};
    private String[] jiaointroduce = {"三都澳又名三沙湾、宁德港，位于福建省宁德市东南部，为中国1.84万公里黄金海岸线的中点。距宁德市区30公里，为闽东沿海的“出入门户，五邑咽喉”，是世界级天然深水良港。",
    ...
    private String[] gubuy = {"¥44","¥80","¥68","free","free","free","free","free","free","free"};
    private String[] guintroduce = {"钱来山风景区位于福建省宁德市古田县大桥镇钱厝村，是福建首个“钱文化”主题旅游风景区。景区总面积666平方公里，以景区出入口为中心，由荷花梯田、樱花谷、820山谷、飞瀑谷、有钱谷和谷里农场6个片区组成，呈环状points布，游步道总长度约3.8公里。钱来山风景区平均海拔820米，夏季从早到晚均温27℃，是福州周边又一避暑胜地。",
    ...
    private String[] pingnanbuy = {"¥120","¥73","free","free","free","free","free","free","free","free","free","¥70","¥70"};
    ...
    private String[] zhoubuy = {"¥60","free","free","free","free","free","free","free","free"};
    private String[] zhouintroduce = {"位于周宁县城西五公里处的浦源村中。鲤鱼溪源于海拔1448米的紫云山麓，汇数十条山涧清泉奔流而下，峰回水转，至浦源村口水势顿减，五弯六曲穿村缓流而过",
    ...
    //Wuxi City
    private String[] wux = {"Yuantouzhu","Water Margin City","Xihui Park","Lingshan Scenic Area","Dangkou Ancient Town","Ancient Canal Scenic Area","Wuxi Zoo","Wuxi Museum","Huishan Temple","Yangshan Stele Material Art Park"};
    private int[] wuxicons = {R.drawable.yuantouzhu,R.drawable.sanguocheng,R.drawable.xihuipark,R.drawable.lingshan,R.drawable.dangkoutown,R.drawable.guyunriver,R.drawable.wuxizoo,R.drawable.wuximuseum,R.drawable.huishantemple,R.drawable.yangshanbeicai};
    private String[] wuxbuy = {"¥138","free","free","free","free","free","free","free","free","free"};
    private String[] wuxintroduce = {"Yuantouzhu Scenic Area in Wuxi, Jiangsu, sprawls over a peninsula on Lake Taihu's northwest shore, renowned for its dragon turtle-shaped rock. It is a key attraction within the nationally designated Lake Taihu Scenic Area. Originally established in 1916, it was later managed by the Wuxi Municipal People's Government and named \"Yuantouzhu Park.\" Noted poet Guo Moruo praised it as Lake Taihu's most picturesque spot. This largest classical garden landscape in the Jiangnan region features famous sites like Chongshan Yinxiu, Luding Yinghui, Yuantouzhu Spring Waves, Hengyun Mountain Villa, and more. It received a 5A-level tourist attraction rating in 2012 and hosts several Jiangsu Province cultural relics protection units.",
    ...
    private String[] fubuy = {"¥56","¥98","¥30","¥38","free","free","free","free","free","free","free"};
    ...
    private String[] zheintroduce ={"柘荣鸳鸯头草场位于省级风景名胜区东狮山南侧，海拔980米至1110米之间，距柘荣县城约5公里。这是一片面积约5000亩，四周被阔叶和针叶混交林包围的草场。周边的山峰巍峨挺拔，充满阳刚之壮美。草场核心区的山岚远远望去，又如person工泥塑的微型盆景。草山低矮，绵延起伏;山脊走势，富有韵律，节奏中蕴含着温文典雅之美妙!",
    ...
    //福鼎市
    private String[] fuding = {"太姥山","牛郎岗海滨景区","翠郊古民居","九鲤溪瀑","小白鹭海滨度假村","大嵛山岛","嵛山岛","赤溪村","石兰村","潋城城堡","点头妈祖宫","福鼎香山寺游览区","天门岭游览区","冷城古堡位","灵峰寺","国兴寺","西阳老person桥","瑶列岛国家级海洋公园","资国寺"};
    ...
    private String[] fudingbuy = {"¥90","¥35","¥25","¥325","¥37","¥10","¥50","¥30","free","free","free","¥120","¥137","free","free","¥140","free","free","free"};
    private String[] fudingintroduce ={"太姥山以花岗岩峰林岩洞为特色，融山、海、川和person文景观于一体，拥有山峻、石奇、洞异、溪秀、瀑急等众多自然景观以及古刹、碑刻等丰富的person文景观，在这里，可以登山、观海、探洞，也可以泛溪、寻古、采风……",
    ...
    private String[] xiapuintroduce ={"杨家溪位于霞浦县牙城镇境内。拥有纬度超北的古榕树群和江南超大的纯枫叶林。其中值得一提的是一株“榕树王”，它的树龄已有800多年，树干周长12.6米，冠幅直径51米，高30米，树干中空，有7个洞口，洞内可容数person。每当早晨的阳光斜斜地洒进树林，斑驳的树影在光影的晃动下展示着它的魔法，营造了一种如梦似幻的感觉。",
    ...
    private String[] qitaintroduce={"钱来山风景区位于福建省宁德市古田县大桥镇钱厝村，是福建首个“钱文化”主题旅游风景区。景区总面积666平方公里，以景区出入口为中心，由荷花梯田、樱花谷、820山谷、飞瀑谷、有钱谷和谷里农场6个片区组成，呈环状points布，游步道总长度约3.8公里。钱来山风景区平均海拔820米，夏季从早到晚均温27℃，是福州周边又一避暑胜地。",
            "大棠休闲农场位于屏南县境内，这里平均海拔830米，年均气温13～18℃，冬无严寒，夏无酷暑,荣获“宁德市休闲农业示范点”。距屏南城关15公里，屏古高速浙洋互通口5公里。",
    ...
    private String[] buytwo={"¥32","free","free","free","free","¥35","free","free","free",
